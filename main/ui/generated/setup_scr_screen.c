...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_cont_1, 3, -17);
    lv_obj_set_size(ui->screen_cont_1, 80, 25);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 0, 0);
    lv_obj_set_size(ui->screen_btn_2, 20, 20);
    ui->screen_btn_2_label = lv_label_create(ui->screen_btn_2);
    lv_label_set_text(ui->screen_btn_2_label, "2");
    ...
    lv_obj_set_pos(ui->screen_btn_1, 20, 0);
    lv_obj_set_size(ui->screen_btn_1, 20, 20);
    ui->screen_btn_1_label = lv_label_create(ui->screen_btn_1);
    lv_label_set_text(ui->screen_btn_1_label, "3");
    ...
    lv_obj_set_style_radius(ui->screen_btn_1, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
