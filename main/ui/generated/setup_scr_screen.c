...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_day, 56, 0);
    lv_obj_set_size(ui->screen_label_day, 82, 13);
    ...
    lv_obj_set_pos(ui->screen_label_local, 102, -12);
    ...
    lv_obj_set_pos(ui->screen_label_w_day, 94, 13);
