...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_tabview_1, 160, 128);
    ...
    lv_tabview_set_tab_bar_size(ui->screen_tabview_1, 15);
    ...
    //Write codes home
    ui->screen_tabview_1_tab_1 = lv_tabview_add_tab(ui->screen_tabview_1,"home");
    lv_obj_t * screen_tabview_1_tab_1_label = lv_label_create(ui->screen_tabview_1_tab_1);
    lv_label_set_text(screen_tabview_1_tab_1_label, "home");

    //Write codes AI_talk
    ui->screen_tabview_1_tab_2 = lv_tabview_add_tab(ui->screen_tabview_1,"AI_talk");
    ...
    lv_obj_set_size(ui->screen_cont_1, 100, 30);
    ...
    lv_obj_set_pos(ui->screen_btn_3, 70, 2);
    ...
    lv_obj_set_style_radius(ui->screen_btn_3, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 48, 3);
    ...
    lv_obj_set_style_radius(ui->screen_btn_2, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->screen_btn_2, &_chatgpt_RGB565A8_20x20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 26, 3);
    ...
    lv_obj_set_style_bg_image_src(ui->screen_btn_1, &_qwen_RGB565A8_20x20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_btn_4 = lv_button_create(ui->screen_tabview_1_tab_2);
    ...
    lv_obj_set_style_radius(ui->screen_btn_4, 12, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_btn_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->screen_btn_4, &_claude_ai_RGB565A8_20x20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_label_answer = lv_textarea_create(ui->screen_tabview_1_tab_2);
    lv_obj_set_pos(ui->screen_label_answer, -13, 14);
    lv_obj_set_size(ui->screen_label_answer, 124, 77);
    lv_textarea_set_text(ui->screen_label_answer, "Hello Waafafa");
    ...
    lv_obj_set_style_radius(ui->screen_label_answer, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
