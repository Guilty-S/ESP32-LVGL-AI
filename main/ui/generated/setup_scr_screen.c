...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_answer, -14, 13);
    lv_obj_set_size(ui->screen_label_answer, 125, 76);
    lv_textarea_set_text(ui->screen_label_answer, "HelloWadfafdffadda");
